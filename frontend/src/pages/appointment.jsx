    ...
    return docInfo && (
        <div className='flex flex-col gap-4'>
            <div className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0'>
                    <p className='text-xl font-semibold'>
                        {docInfo.name} <img className='inline-block w-5 h-5' src={assets_frontend.verified_icon} alt="Verified Icon" />
                    </p>
                    <p className='text-gray-700'>{docInfo.degree} - {docInfo.speciality}</p>
            ...
            <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
                <p>Booking slots</p>
                <div className='flex gap-3 items-center w-full overflow-x-scroll mt-4'>
                    {docSlots.length > 0 && docSlots.map((slotsForDay, index) => (
                        <div
                            key={index}
                        ...
                        >
                            <p>{daysofweek[new Date(slotsForDay[0]?.datetime).getDay()]}</p>
                            <p>{new Date(slotsForDay[0]?.datetime).getDate()}</p>
                        </div>
                    ))}
                </div>
                <div className='mt-4'>
